    ...
    private void onResult(final AIResponse response) {
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                Log.i(TAG, "Hello: " +  result.getContexts().get(0).getParameters().get("given-name"));
                ...
                final String end_state="Okay! Thank you for registering for codeshastra!";
                ...
                done_button.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        String name = result.getContexts().get(0).getParameters().get("given-name").toString();
                        String number= result.getContexts().get(0).getParameters().get("phone-number").toString();
                        String email = result.getContexts().get(0).getParameters().get("email.original").toString();
                        String last="asas";
